...
<head>
    ...
    <title>WSI - Site Maker Log in</title>
            ...
            <div class="col-lg-6">
                <div class="sign-wrapper">
                    <div class="wd-100p">
                        ...
                        <p class="tx-color-03 tx-14 mg-b-40">Welcome to WSI - Site Maker. Please sign in to continue.</p>
                        <form method="POST" action="{{ route('login.post') }}">
                            ...
                            <!-- <a href="#" class="btn btn-info btn-sm">Forgot Password</a> -->
                        </form>
