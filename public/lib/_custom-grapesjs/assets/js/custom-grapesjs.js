...
const editor = grapesjs.init({
    ...
    canvas: {
        styles: [
            app_url + "/theme/css/fonts/default.css",
            app_url + "/theme/css/bootstrap.css",
            app_url + "/theme/css/style-vars.css",
            app_url + "/theme/css/dark.css",
            app_url + "/theme/css/font-icons.css",
            app_url + "/theme/css/et-line.css",
            app_url + "/theme/css/medical-icons.css",
            app_url + "/theme/css/realestate-icons.css",
            app_url + "/theme/css/animate.css",
            app_url + "/theme/css/magnific-popup.css",
            app_url + "/theme/include/cookie-alert/cookiealert.css",
            app_url + "/theme/include/slick/slick.css",
            app_url + "/theme/include/slick/slick-theme.css",
            app_url + "/theme/css/responsive.css",
            app_url + "/theme/css/custom.css",
            app_url + "/theme/css/swiper.css",
        ],
        scripts: [
            app_url + "/theme/js/jquery.js",
            app_url + "/theme/js/plugins.js",
            app_url + "/theme/include/slick/slick.js",
            app_url + "/theme/include/cookie-alert/cookiealert.js",
            app_url + "/theme/js/functions.js",
            app_url + "/theme/js/script.js",
        ],
    },
...
window.addEventListener("load", () => {
	...
	if(jsPage) {
        ...
        editor.addComponents(jsHtml + jsStyle);
    }
