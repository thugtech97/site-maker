...
const editor = grapesjs.init({
    ...
    canvas: {
        styles: [
            app_url + "/theme/" + app_theme_folder + "/css/style.css",
        ],
        scripts: [
            app_url + "/theme/" + app_theme_folder + "/js/jquery.js",
            app_url + "/theme/" + app_theme_folder + "/js/plugins.min.js",
            app_url + "/theme/" + app_theme_folder + "/js/functions.js",
            app_url + "/theme/" + app_theme_folder + "/js/script.js",
        ],
    },
...
cmdm.add('open-assets', {
	run(editor, sender, opts = {}) {
		var type = "image";
		var route_prefix =
            app_url + "/admin-panel/laravel-filemanager";;
